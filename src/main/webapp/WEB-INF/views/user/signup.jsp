    ...
    <div class="signup-container">
        ...
        <div class="logo-section">
            <div class="character-icon">
                <img src="<c:url value='/resources/images/에그머니.png'/>" alt="에그머니 로고" class="logo-icon">
            </div>
        </div>
            ...
            <div class="form-section">
                <div class="input-group">
                    ...
                    <form:input path="email" type="email" id="email"
                        class="input-field" placeholder="이메일을 입력하세요" required="true" />
                    <form:errors path="email" cssClass="error-message" />
                </div>

                <div class="input-group">
                    <label class="input-label" for="name">이름</label>
                    <form:input path="name" type="text" id="name" class="input-field"
                        placeholder="이름을 입력하세요" required="true" />
                ...
                <div class="input-group">
                    ...
                    <form:input path="password" type="password" id="password"
                        class="input-field" placeholder="비밀번호를 입력하세요" required="true" />
                ...
                <div class="input-group">
                    ...
                    <form:input path="confirmPassword" type="password"
                        ...
                        placeholder="비밀번호를 다시 입력하세요" required="true" />
